...
export class ProductlistComponent {
  ...
  @Input()
  search_Prod_Container: string = '';

  // to keep track of radio buttn seected in parent component create a property by any name
   buttonparent:string = 'all'
   onFilterChange( value: string){
     
    this.buttonparent= value;
    console.log(value)
    // console.log(" on filter change called")
  } //bina output import kiye ye msg log nhi hoga
}
